...
The official Docker Compose already includes the downloader service. Follow the [remote downloader guide](/docs/guides/remote-downloader/) and [WebDAV configuration](/docs/configuration/webdav/) to connect the first clients.
