...
After upgrading, verify the current edition on About, then review Public URL, registration, default quotas, and email before opening the site to users. Follow the [administrator guide](/docs/site-management/overview/) and [site settings guide](/docs/site-management/basic/public-url/) for the recommended order.
