		...
		starlight({
			...
			sidebar: [
				...
				sidebarGroup('Site management', '站点管理', [
					sidebarLink('Basic settings', '基础配置', 'docs/site-management/public-url'),
					sidebarLink(
						'Login and email',
						'登录与邮件',
						'docs/site-management/oauth',
					),
					sidebarLink('Object storage', '对象存储', 'docs/site-management/storage'),
					sidebarLink('User management', '用户管理', 'docs/site-management/users'),
					sidebarLink('Team management', '团队管理', 'docs/site-management/teams'),
					sidebarLink(
						'Downloaders',
						'下载器',
						'docs/site-management/download-node-deploy',
					),
					sidebarLink(
						'Site announcements',
						'站点公告',
						'docs/site-management/announcements',
					),
					sidebarLink(
						'Audit logs',
						'审计日志',
						'docs/site-management/audit-logs',
					),
					sidebarLink(
						'Analytics',
						'数据分析',
						'docs/site-management/analytics',
					),
					sidebarLink(
						'Licensing',
						'授权管理',
						'docs/site-management/licensing',
					),
				]),
